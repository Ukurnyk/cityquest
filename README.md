...
Для работы с API необходимо получить актуальную схему GraphQL.

### Получение схемы

1. Обратитесь к разработчикам для получения актуальной схемы
2. Поместите полученную схему в файл `src/gql/schema.graphql`
3. После этого можно генерировать типы GraphQL с помощью команды:
